...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/_internal/cpython-3.12.12/bin',
 'BINLIBDEST': '/opt/_internal/cpython-3.12.12/lib/python3.12',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-g -O2 -Wall -fdebug-prefix-map=/=. '
                            ...
                            '-D_FORTIFY_SOURCE=2 -std=c11 -Wextra '
 ...
 'CONFIG_ARGS': "'CC=gcc' 'CXX=g++' 'CFLAGS_NODIST=-g -O2 -Wall "
                ...
                "-Wl,-z,now ' '--prefix=/opt/_internal/cpython-3.12.12' "
                "'--disable-shared' '--with-ensurepip=no' "
                "'--with-openssl=/opt/_internal/openssl-3.5' "
                "'--with-openssl-rpath=auto' "
                "'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig' "
                "'TCLTK_LIBS=-L/usr/local/lib -ltk8.6 -ltcl8.6'",
 'CONFINCLUDEDIR': '/opt/_internal/cpython-3.12.12/include',
 'CONFINCLUDEPY': '/opt/_internal/cpython-3.12.12/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Python-3.12.12/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/Python-3.12.12/lcov-report',
 ...
 'DESTDIRS': '/opt/_internal/cpython-3.12.12 '
             '/opt/_internal/cpython-3.12.12/lib '
             '/opt/_internal/cpython-3.12.12/lib/python3.12 '
             '/opt/_internal/cpython-3.12.12/lib/python3.12/lib-dynload',
 'DESTLIB': '/opt/_internal/cpython-3.12.12/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/opt/_internal/cpython-3.12.12/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/opt/_internal/cpython-3.12.12/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 ...
 'INCLDIRSTOMAKE': '/opt/_internal/cpython-3.12.12/include '
                   '/opt/_internal/cpython-3.12.12/include '
                   '/opt/_internal/cpython-3.12.12/include/python3.12 '
                   '/opt/_internal/cpython-3.12.12/include/python3.12',
 'INCLUDEDIR': '/opt/_internal/cpython-3.12.12/include',
 'INCLUDEPY': '/opt/_internal/cpython-3.12.12/include/python3.12',
 ...
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/opt/_internal/cpython-3.12.12/lib/python3.12',
 'LIBDIR': '/opt/_internal/cpython-3.12.12/lib',
 'LIBEXPAT_A': 'Modules/expat/libexpat.a',
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare '
                    '-DNDEBUG -g -O3 -Wall -g -O2 -Wall -fdebug-prefix-map=/=. '
                    '-fstack-protector-strong -Wformat -Werror=format-security '
                    '-Wdate-time -D_FORTIFY_SOURCE=2 -std=c11 -Wextra '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/_internal/cpython-3.12.12/lib/pkgconfig',
 'LIBPL': '/opt/_internal/cpython-3.12.12/lib/python3.12/config-3.12-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/_internal/cpython-3.12.12/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/_internal/cpython-3.12.12/share/man',
 ...
 'MODULE__CRYPT_CFLAGS': '-I/usr/local/include',
 'MODULE__CRYPT_LDFLAGS': '-L/usr/local/lib -lcrypt',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/opt/_internal/openssl-3.5/lib  '
                            '-Wl,--enable-new-dtags,-rpath=/opt/_internal/openssl-3.5/lib  '
                            '-lcrypto',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/opt/_internal/sqlite3/include   '
                           '-I./Modules/_sqlite',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-Wl,--enable-new-dtags,-rpath=/opt/_internal/sqlite3/lib '
                            '-L/opt/_internal/sqlite3/lib -lsqlite3',
 ...
 'MODULE__SSL_LDFLAGS': '-L/opt/_internal/openssl-3.5/lib  '
                        '-Wl,--enable-new-dtags,-rpath=/opt/_internal/openssl-3.5/lib '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/usr/local/include   -Wno-strict-prototypes '
                           '-DWITH_APPINIT=1',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/opt/_internal/cpython-3.12.12/lib',
 ...
 'VERSION': '3.12',
 'WASM_ASSETS_DIR': './opt/_internal/cpython-3.12.12',
 'WASM_STDLIB': './opt/_internal/cpython-3.12.12/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/Python-3.12.12',
 'abs_srcdir': '/Python-3.12.12',
 'datarootdir': '/opt/_internal/cpython-3.12.12/share',
 'exec_prefix': '/opt/_internal/cpython-3.12.12',
 'prefix': '/opt/_internal/cpython-3.12.12',
 'srcdir': '.'}
